...
|--------------------|-------------------|---------|
| AAAK Compression   | ~1785 ops/sec     | 560 µs  |
| Entity Detection   | ~260030 ops/sec   | 4 µs    |
| Token Counting     | ~3558892 ops/sec  | 281 ns  |
| Compression Stats  | ~1359217 ops/sec  | 736 ns  |
<!-- BENCH_TABLE_END -->
...
| **BABILONG  ** | 1.000 | Reasoning  | 523.0 ms |
