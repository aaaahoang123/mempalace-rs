...
| **BABILONG  ** | 1.000 | Reasoning  | 553.0 ms |
...
|--------------------|-------------------|---------|
| AAAK Compression   | ~1816 ops/sec     | 550 µs  |
| Entity Detection   | ~250011 ops/sec   | 4 µs    |
| Token Counting     | ~3755207 ops/sec  | 266 ns  |
| Compression Stats  | ~1373454 ops/sec  | 728 ns  |
<!-- BENCH_TABLE_END -->
