...
|--------------------|-------------------|---------|
| AAAK Compression   | ~1773 ops/sec     | 564 µs  |
| Entity Detection   | ~256413 ops/sec   | 4 µs    |
| Token Counting     | ~3674479 ops/sec  | 272 ns  |
| Compression Stats  | ~1388990 ops/sec  | 720 ns  |
<!-- BENCH_TABLE_END -->
...
|------|----------|-----------|---------------|
| RAW  | 100.0%   | 100.0%    | 179.5ms       |
| AAAK | 100.0%   | 100.0%    | 426.5ms       |
<!-- ACCURACY_TABLE_END -->
